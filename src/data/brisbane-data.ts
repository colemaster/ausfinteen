...
/** Median weekly rents by Brisbane suburb (RTA Q1 2026 new-tenancy medians via rental-market data, Mar 2026; sharehouse rooms indicative listings) */
export interface SuburbRent {
  suburb: string;
  sharedWeekly: string; // room in sharehouse (indicative listings range)
  unitWeekly: string; // 1-2 bed unit median (RTA Q1 2026 new tenancies unless noted)
  commute: string;
  vibe: string;
}

export const BRISBANE_SUBURBS: SuburbRent[] = [
  { suburb: 'St Lucia', sharedWeekly: '$350–500', unitWeekly: '$690 (~$815 house)', commute: 'Bus/ferry 15 min', vibe: 'UQ student hub (UQ premium; catered colleges $509–777/wk)' },
  { suburb: 'Toowong', sharedWeekly: '$280–400', unitWeekly: '$500–690 (asking ~$690; RTA page split)', commute: 'Train 10 min', vibe: 'Convenient, safe' },
  { suburb: 'South Bank / West End', sharedWeekly: '$380–520', unitWeekly: '$750+ (asking; RTA page empty)', commute: 'Walk/bus 10 min', vibe: 'Trendy, riverside' },
  { suburb: 'Fortitude Valley', sharedWeekly: '$400–600', unitWeekly: '$510–750 (sources conflict — verify)', commute: 'Train 5 min', vibe: 'Nightlife district (~81% renters)' },
  { suburb: 'New Farm', sharedWeekly: '$400–600', unitWeekly: '$740 (~$830 house)', commute: 'Ferry/bus 10 min', vibe: 'Riverside premium' },
  { suburb: 'Teneriffe', sharedWeekly: '$400–600', unitWeekly: '$800 (houses rare)', commute: 'CityCat + bus 10–15 min', vibe: 'Woolstore-chic riverfront apartments' },
  { suburb: 'Paddington', sharedWeekly: '$350–500', unitWeekly: '$675 (~$860 house)', commute: 'Bus + train 15 min', vibe: 'Village-y inner-west, character cottages' },
  { suburb: 'Auchenflower', sharedWeekly: '$330–480', unitWeekly: '$675 (~$990 house)', commute: 'Train + bus 10 min', vibe: 'River walks, quick city access' },
  { suburb: 'Taringa', sharedWeekly: '$280–420', unitWeekly: '$650 (~$780 house)', commute: 'Train 10–15 min', vibe: 'UQ student heartland, cheap eats' },
  { suburb: 'Indooroopilly', sharedWeekly: '$280–400', unitWeekly: '$725 (~$735 house)', commute: 'Train 20 min', vibe: 'Affordable, family-friendly' },
  { suburb: 'Bulimba', sharedWeekly: '$380–520', unitWeekly: '$720 (~$960 house)', commute: 'CityCat ferry 20–25 min', vibe: 'Polished riverside east, Oxford St dining' },
  { suburb: 'Camp Hill', sharedWeekly: '$280–400', unitWeekly: '$480 (~$800 house)', commute: 'Bus 20–30 min', vibe: 'Leafy family hill, big-block Queenslanders' },
  { suburb: 'Carina', sharedWeekly: '$260–380', unitWeekly: '$650 (~$720 house)', commute: 'Bus 25–30 min', vibe: 'Quiet suburban value near Cannon Hill' },
  { suburb: 'Moorooka', sharedWeekly: '$240–360', unitWeekly: '$570 (~$725 house)', commute: 'Train 15–20 min', vibe: 'Vintage strip, affordable Queenslander shares' },
  { suburb: 'Salisbury', sharedWeekly: '$220–330', unitWeekly: '$410 (~$650 house)', commute: 'Train 20–25 min', vibe: 'Cheapest southside entry in this set' },
  { suburb: 'Annerley', sharedWeekly: '$240–350', unitWeekly: '$580 (~$720 house)', commute: 'Bus 25 min', vibe: 'Budget south-side option' },
  { suburb: 'Kelvin Grove', sharedWeekly: '$330–450', unitWeekly: '$720 (~$725 house)', commute: 'Bus 15 min', vibe: 'QUT creative campus (rooms from ~$180)' },
  { suburb: 'Chermside', sharedWeekly: '$250–350', unitWeekly: '$650 (~$700 house)', commute: 'Bus 30 min', vibe: 'Suburban value' },
];
...
export const QLD_HIGH_SCHOOLS: HighSchool[] = [
  ...
  },
  {
    ...
    website: 'https://gladstonshs.eq.edu.au',
  },
  {
  ...
  },
  {
    ...
    website: 'https://fernygroveshs.eq.edu.au',
  },
  {
  ...
  // ─── Toowoomba (Darling Downs) ────────────────────────────────────────────────
  {
    ...
    website: 'https://www.twgs.qld.edu.au',
  },
  {
...
// ─── Lockyer / Darling Downs (regional) ────────────────────────────────────
  {
    ...
    type: 'State',
    suburb: 'Gatton (Lockyer Valley)',
    yearLevels: '7–12',
    indicativeICSEA: 960,
    notable: 'Regional state school with strong agricultural and trade programs. Well-known for VET pathways.',
    website: 'https://lockyerdistrictshs.eq.edu.au',
  },
  {
    name: 'Ipswich State High School',
    type: 'State',
    suburb: 'Brassall (Ipswich)',
    yearLevels: '7–12',
    notable: 'Major Ipswich state school with strong academic, sporting and cultural programs.',
    website: 'https://ipswichshs.eq.edu.au',
  },
  {
  ...
  },
  {
    ...
    website: 'https://rosewoodshs.eq.edu.au',
  },
  {
  ...
  },
  {
    ...
    website: 'https://shailerparkshs.eq.edu.au',
  },
  {
    name: 'Victoria Point State High School',
    type: 'State',
    suburb: 'Victoria Point (Redlands)',
    yearLevels: '7–12',
    notable: 'Bayside Redlands state school with strong academic and marine science programs.',
    website: 'https://vpshs.eq.edu.au',
  },
  // ─── Moreton Bay ─────────────────────────────────────────────────────────
  {
  ...
  },
  {
    ...
    indicativeICSEA: 960,
    notable: 'Strong academic results in Moreton Bay. Popular state school with good ATAR outcomes.',
    website: 'https://deceptionbayshs.eq.edu.au',
  },
  // ─── Gold Coast extras ───────────────────────────────────────────────────
  {
  ...
  },
  {
    ...
    website: 'https://clevelanddistrictshs.eq.edu.au',
  },
  {
  ...
  // ─── Brisbane South / Logan corridor ─────────────────────────────────────
  {
    name: 'Stretton State College',
    type: 'State',
    suburb: 'Stretton (Brisbane S)',
    yearLevels: 'Prep–12',
    indicativeICSEA: 1068,
    notable: 'High-performing large P–12 college (~3,500 students) across Gowan + Illaweena campuses.',
    website: 'https://strettonsc.eq.edu.au',
  },
  {
    name: 'Calamvale Community College',
    type: 'State',
    suburb: 'Calamvale (Brisbane S)',
    yearLevels: 'Prep–12',
    indicativeICSEA: 1026,
    notable: 'IB World School (PYP + Diploma). ~2,600 students from 66 nationalities.',
    website: 'https://calamvalecc.eq.edu.au',
  },
  {
    name: 'Rochedale State High School',
    type: 'State',
    suburb: 'Rochedale (Brisbane S)',
    yearLevels: '7–12',
    indicativeICSEA: 1034,
    notable: 'Rising southside state school with a performing-arts vision and strong NAPLAN growth.',
    website: 'https://rochedaleshs.eq.edu.au',
  },
  {
    name: 'Springwood State High School',
    type: 'State',
    suburb: 'Springwood (Logan)',
    yearLevels: '7–12',
    indicativeICSEA: 991,
    notable: 'Bushland campus with eSports Hub + Innovation Centre and broad excellence programs.',
    website: 'https://springwoodshs.eq.edu.au',
  },
  {
    name: 'Beenleigh State High School',
    type: 'State',
    suburb: 'Beenleigh (Logan)',
    yearLevels: '7–12',
    indicativeICSEA: 928,
    notable: 'Long-established Logan corridor high with strong vocational and Link-and-Launch pathways.',
    website: 'https://beenleighshs.eq.edu.au',
  },
  {
    name: 'Windaroo Valley State High School',
    type: 'State',
    suburb: 'Bahrs Scrub (Logan)',
    yearLevels: '7–12',
    indicativeICSEA: 972,
    notable: 'Growth-corridor state high with broad curriculum and extracurricular pathways.',
    website: 'https://windaroovalleyshs.eq.edu.au',
  },
  {
    name: 'Canterbury College',
    type: 'Independent',
    suburb: 'Waterford (Logan)',
    yearLevels: 'Prep–12',
    indicativeICSEA: 1076,
    notable: 'Co-ed Anglican school (est 1987). Self-described Logan\'s leading all-rounder school.',
    website: 'https://canterbury.qld.edu.au',
  },
  // ─── Gold Coast north / south extras ─────────────────────────────────────
  {
    name: 'Ormeau Woods State High School',
    type: 'State',
    suburb: 'Ormeau (Gold Coast N)',
    yearLevels: '7–12',
    indicativeICSEA: 996,
    notable: '"Four Pillars" model with Excellence Academy (Academic, Dance, Media, Football, Rugby League).',
    website: 'https://ormeauwoodsshs.eq.edu.au',
  },
  {
    name: 'Pimpama State Secondary College',
    type: 'State',
    suburb: 'Pimpama (Gold Coast N)',
    yearLevels: '7–12',
    indicativeICSEA: 966,
    notable: 'Growth-corridor college (opened 2013) serving the northern Gold Coast boom suburbs.',
    website: 'https://pimpamassc.eq.edu.au',
  },
  {
    name: 'Coomera Anglican College',
    type: 'Independent',
    suburb: 'Upper Coomera (Gold Coast N)',
    yearLevels: 'Prep–12',
    indicativeICSEA: 1084,
    notable: 'Co-ed Anglican Early Learning–12 college with a future-focused learning program.',
    website: 'https://www.cac.qld.edu.au',
  },
  {
    name: "King's Christian College",
    type: 'Independent',
    suburb: 'Reedy Creek (Gold Coast)',
    yearLevels: 'Prep–12',
    indicativeICSEA: 1074,
    notable: 'Co-ed Christian college (est 1980, 2,600+ students) incl. trade training centre; +Pimpama/Logan Village campuses.',
    website: 'https://www.kingscollege.qld.edu.au',
  },
  {
    ...
    suburb: 'Reedy Creek (Gold Coast)',
    yearLevels: 'Prep–12',
    notable: 'Co-ed Christian college (est 1982). Strong community school in the southern Gold Coast growth belt.',
    website: 'https://www.hillcrest.qld.edu.au',
  },
  {
    name: 'Coombabah State High School',
    type: 'State',
    suburb: 'Coombabah (Gold Coast)',
    yearLevels: '7–12',
    indicativeICSEA: 977,
    notable: 'Inclusive campus with excellence programs and wide extracurricular options.',
    website: 'https://coombabashs.eq.edu.au',
  },
  {
    name: 'Elanora State High School',
    type: 'State',
    suburb: 'Elanora (Gold Coast)',
    yearLevels: '7–12',
    indicativeICSEA: 1023,
    notable: 'Independent Public School since 2017 with strong tertiary partnerships.',
    website: 'https://elanorashs.eq.edu.au',
  },
  {
    name: 'Palm Beach-Currumbin State High School',
    type: 'State',
    suburb: 'Palm Beach (Gold Coast)',
    yearLevels: '7–12',
    indicativeICSEA: 1022,
    notable: '~2,600 students with a renowned academic, sporting and arts record ("Nil Sed Optima").',
    website: 'https://pbc-shs.eq.edu.au',
  },
  {
    name: 'Helensvale State High School',
    type: 'State',
    suburb: 'Helensvale (Gold Coast)',
    yearLevels: '7–12',
    indicativeICSEA: 1017,
    notable: '~2,000 students with academies in EXCITE, AFL, netball, dance and Japanese.',
    website: 'https://helensvaleshs.eq.edu.au',
  },
  {
    ...
    yearLevels: '7–12',
    indicativeICSEA: 1009,
    notable: 'Growth-suburb state high focused on excellence pathways and community links.',
    website: 'https://pacificpinesshs.eq.edu.au',
  },
  // ─── Ipswich / Wide Bay / Mackay extras ──────────────────────────────────
  {
    name: 'West Moreton Anglican College',
    type: 'Independent',
    suburb: 'Karrabin (Ipswich)',
    yearLevels: 'Prep–12',
    indicativeICSEA: 1072,
    notable: 'Major Ipswich-region co-ed Anglican school with strong academic and outdoor programs.',
  ...
  },
  {
    ...
    yearLevels: '7–12',
    indicativeICSEA: 936,
    notable: 'Est 1912, among QLD\'s first state highs. ~1,260 students in the Mackay sugar and mining hub.',
  ...
  },
  {
    ...
    yearLevels: '7–12',
    indicativeICSEA: 944,
    notable: 'Opened 1912 on the Burnett River with an Excel academic enrichment program.',
    website: 'https://bundabergshs.eq.edu.au',
  },
  {
    name: 'Hervey Bay State High School',
    type: 'State',
    suburb: 'Pialba (Hervey Bay)',
    yearLevels: '7–12',
    indicativeICSEA: 963,
    notable: '~1,270 students with marine studies, ag science and USC head-start subjects.',
    website: 'https://herveybayshs.eq.edu.au',
  },
  {
    ...
    yearLevels: '7–12',
    indicativeICSEA: 976,
    notable: 'Gympie\'s state secondary (est 1977, ~1,100 students) with strong trade and academic pathways.',
    website: 'https://jamesnashshs.eq.edu.au',
  },
];
...
export const QLD_TAFE = {
  feeFreeCourses2026: [
    '22603VIC Certificate IV in Cyber Security — IT & cyber',
    'FNS40222 Certificate IV in Accounting and Bookkeeping — business',
    'ICT30120 Certificate III in Information Technology — IT support',
    'CHC30125 Certificate III in Early Childhood Education and Care — childcare',
    'CHC30121 Certificate III in ECEC (Aboriginal & Torres Strait Islander stream)',
    'CHC50125 Diploma of Early Childhood Education and Care — childcare director',
    'CHC30221 Certificate III in School Based Education Support — teacher aide',
    'CHC40225 Certificate IV in School Based Education Support — senior teacher aide',
    'CHC32015 Certificate III in Community Services — community work',
    'CHC33021 Certificate III in Individual Support (Ageing/Disability) — aged care',
    'CHC40321 Certificate IV in Child, Youth and Family Intervention — youth support',
    'CHC40421 Certificate IV in Youth Work — youth work',
    'CHC43315 Certificate IV in Mental Health — mental health support',
    'HLT30121 Certificate III in Aboriginal and/or Torres Strait Islander Primary Health Care',
    'HLT33115 Certificate III in Health Services Assistance — hospital support',
    'HLT35021 Certificate III in Dental Assisting — dental',
    'HLT37015 Certificate III in Sterilisation Services — hospital sterilisation',
    'HLT37215 Certificate III in Pathology Collection — pathology',
    'HLT37315 Certificate III in Health Administration — health admin',
    'HLT43021 Certificate IV in Allied Health Assistance — allied health',
    'HLT47321 Certificate IV in Health Administration — senior health admin',
    'CHCSS00070 Assist Clients with Medication Skill Set — short course (existing workers)',
    'AHC30122 Certificate III in Agriculture — farming',
    'AHC32822 Certificate III in Rural Operations — rural industries',
    'AHC30722 Certificate III in Horticulture — gardening & landscaping',
    'AHC51422 Diploma of Agribusiness Management — farm business',
    'FBP30121 Certificate III in Food Processing (Brewing) — brewing',
    'SIT30622 Certificate III in Hospitality — hospitality',
    'SIT30125 Certificate III in Tourism — tourism',
    '11054NAT Certificate II in Plumbing Services — pre-apprenticeship',
    'CPC40920 Certificate IV in Plumbing and Services — hydraulic design',
    'CPP40121 Certificate IV in Residential Drafting — building design',
    'MEM40422 Certificate IV in Engineering Drafting — CAD drafting',
    'MSF50222 Diploma of Interior Design — interior design',
    'MSA30208 Certificate III in Manufacturing Technology (CAD) — manufacturing',
  ],
  /** Top priority apprenticeships/traineeships with training fees fully covered for under-25s (contract 1 Jan 2021 – 30 Jun 2027) */
  freeApprenticeshipCoursesU25: [
    'UEE30820 Certificate III in Electrotechnology Electrician — electrical apprenticeship',
    'CPC30220 Certificate III in Carpentry — carpentry apprenticeship',
    'CPC32420 Certificate III in Plumbing — plumbing apprenticeship',
    'AUR30620 Certificate III in Light Vehicle Mechanical Technology — mechanic',
    'SHB30416 Certificate III in Hairdressing — hairdressing',
    'SIT30821 Certificate III in Commercial Cookery — chef/cook',
    'MEM30319 Certificate III in Engineering — Fabrication Trade — boilermaker/welder',
    'MEM30219 Certificate III in Engineering — Mechanical Trade — fitter/machinist',
    'UEE32220 Certificate III in Air-conditioning & Refrigeration — HVAC',
    'AUR30320 Certificate III in Automotive Electrical Technology — auto electrical',
    'AUR32721 Certificate III in Automotive Electric Vehicle Technology — EV technician',
    'AUR31120 Certificate III in Heavy Commercial Vehicle Mechanical — diesel mechanic',
    'SHB30516 Certificate III in Barbering — barbering',
    'CPC33020 Certificate III in Bricklaying/Blocklaying — bricklaying',
    'CPC32620 Certificate III in Roof Plumbing — roof plumbing',
    'CPC31920 Certificate III in Joinery — joinery',
    'CPC30620 Certificate III in Painting and Decorating — painting',
    'RII30820 Certificate III in Civil Construction — civil construction',
    'MSL40122 Certificate IV in Laboratory Techniques — lab technician',
    'CHC33021 Certificate III in Individual Support (traineeship route) — aged care',
  ],
  feeFreeNote: 'Fee-Free TAFE runs to 31 Dec 2026 at TAFE QLD + CQUniversity only (CQU 2026 places filled — check availability). One Fee-Free qualification per student 2023–2026 (exception: both Cert III + Diploma of Early Childhood allowed). Open to QLD residents 15+ not enrolled at school/uni, with priority cohorts (under 25, jobseekers, First Nations, carers, disability) guaranteed. Trades, nursing and community courses below sit under sibling programs (Free Apprenticeships U25 / Free Nursing) — check the exact program before enrolling.',
  freeApprenticeships: {
  ...
  freeConstructionOver25: 'Free Construction Apprenticeships for Over 25s covers full tuition for ~30 priority construction trades (bricklaying, carpentry, plumbing, painting, tiling, roofing, civil construction, electrical, refrigeration, cabinet-making). Contracts 1 Jul 2024 – 30 Jun 2027 at TAFE QLD + CQUniversity.',
  freeNursing2026: 'Free Nursing: the Diploma of Nursing (HLT54121, Enrolled Nurse) is fully funded in 2026 under Fee-Free TAFE — same residency/age/not-at-school/one-qualification rules apply. 2,000 extra state-funded places added Dec 2025; TAFE QLD notes Semester 1 2026 commencements — check Semester 2 availability.',
