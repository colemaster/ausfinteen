...
const CALCULATORS_LIST: CalcCard[] = [
  ...
  },
  {
    ...
    title: 'First Job Payslip & Penalty Rate Simulator',
    category: 'tax_super',
    badge: 'Fair Work 2026',
    badgeColor: 'bg-blue-500/10 text-blue-600 dark:text-blue-400 border-blue-500/30',
    description: 'Calculate junior award wages, 25% casual loading, 3-hour minimum shifts, Saturday/Sunday penalties, and meal allowances.',
    route: '/careers-employment',
    icon: Coins,
    stats: '40% junior rate • 3hr min shifts',
  },
  {
    id: 'interest-products',
    title: '5.0%+ Youth HISA & Bonus Interest Finder',
    category: 'investing',
    badge: 'APRA $250k Protected',
    badgeColor: 'bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border-emerald-500/30',
    description: 'Compare top Australian high-interest youth savings accounts (5.0%–5.75% p.a.) and verify monthly deposit bonus conditions.',
    route: '/interest-products',
    icon: TrendingUp,
    stats: '5.0%-5.75% p.a. • $250k FCS guarantee',
  },
  {
    id: 'spending-saving',
    title: 'Student Discount & Subscription Optimizer',
    category: 'debt_budget',
    badge: '50c Fares & Tech Deals',
    badgeColor: 'bg-cyan-500/10 text-cyan-600 dark:text-cyan-400 border-cyan-500/30',
    description: 'Calculate your annual savings from 50c public transport fares, SIM-only MVNO plans ($15–$25/mo), and Apple/Spotify student discounts.',
    route: '/spending-saving',
    icon: Sparkles,
    stats: '$1,800+/yr average teen savings',
  },
];
