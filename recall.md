...
| v6.4.0  | Sept 2026 500-Source Data Refresh | 5-stream parallel web audit (~400 sources: ATO/StudyAssist/QCAA/QTAC/QS 2027/MySchool/RBA/FWC/Fair Work/QRO/TMR/TransLink/ASX/issuers/RACQ/AIP/Services Australia): MLS 2026-27 thresholds ($105k/$123k/$164k), TAS FHB duty relief expiry + $20k FHOG, ACT FHB duty abolition uncapped, WATO typo fix + HELP/VSL/FEE-HELP/co-cont/RBA/NMW constants, Youth Allowance correction ($418.90/$482.40/$539 + $646 taper), NAT 3093 fix, approved-consent wording, Up 5.35% + Westpac Life 5.75%, fuel Aug-2026 + 40-day cycle, EV defaults ($2.02/16kWh/30c/65c + tests), QLD unis (UniSC 1001+, UQ THE =80, Brisbane street addresses), enrolments refresh, QILT 2025 nationals + QTAC 2027 fees, 41 precise ATAR cut-offs, 14 new QLD schools (79 total), QLD FHB/TAFE/costs refresh, V1AC replaces MGOC, QUT QS #240 topic fix | Local |
