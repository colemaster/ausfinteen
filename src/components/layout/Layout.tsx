...
export function Layout() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground transition-colors duration-200">
      ...
      <div
        className="fixed top-0 left-0 z-50 h-[3px] bg-gradient-to-r from-primary via-violet-500 to-warning transition-[width] duration-150 ease-out scroll-progress-native"
