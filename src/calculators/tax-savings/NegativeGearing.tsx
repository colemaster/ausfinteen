...
export function NegativeGearing() {
  ...
  return (
    <div className="space-y-5">
      ...
      <div className={`rounded-xl px-4 py-3 border text-sm font-medium ${result.isPositivelyGeared ? 'bg-green-50 border-green-200 text-green-700 ' : 'bg-[var(--primary)]/10 border-[var(--primary)]/20 text-[var(--primary)] ' }`}
      >
